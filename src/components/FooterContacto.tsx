    ...
    <footer className="w-full bg-[var(--azul-legal)] px-0 text-white pt-10 pb-4">
      <div className="w-full flex flex-col md:flex-row items-stretch justify-between h-full px-4 md:px-12 xl:px-24 gap-8 md:gap-0">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left flex-1 w-full md:w-auto mx-auto md:mx-0 mb-8 md:mb-0 px-2">
          <div style={{ position: 'relative', width: '140px', height: '70px' }} className="mb-4 mx-auto">
            <Image src="/Logo.png" alt="Colombo & Hurd Logo" fill sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 140px" style={{ objectFit: 'contain' }} />
          </div>
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1 w-full md:w-auto mx-auto md:mx-0 gap-3 mb-8 md:mb-0 px-2">
          ...
          <div className="flex items-center gap-2 text-lg justify-center md:justify-start">
            ...
            <a href="https://wa.me/19495947776" onClick={handleWhatsAppClick} className="hover:text-[var(--dorado-elegante)] transition-colors" target="_blank" rel="noopener noreferrer">+1 (949) 594-7776</a>
          </div>
          <div className="flex items-center gap-2 text-lg justify-center md:justify-start">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1 w-full md:w-auto mx-auto md:mx-0 gap-4 mb-8 md:mb-0 px-2">
          ...
          <div className="flex flex-col gap-3 w-full items-center">
            ...
            <a href="https://wa.me/19495947776" onClick={handleWhatsAppClick} className="flex items-center justify-center gap-2 text-lg font-medium hover:text-[var(--dorado-elegante)] transition-colors" target="_blank" rel="noopener noreferrer">
              {/* WhatsApp */}
            ...
            <a href="https://www.instagram.com/colombo.hurdlaw01/" className="flex items-center justify-center gap-2 text-lg font-medium hover:text-[var(--dorado-elegante)] transition-colors" target="_blank" rel="noopener noreferrer">
              {/* Instagram */}
            ...
            <a href="https://www.tiktok.com/@colombo_hurdlaw" className="flex items-center justify-center gap-2 text-lg font-medium hover:text-[var(--dorado-elegante)] transition-colors" target="_blank" rel="noopener noreferrer">
              {/* TikTok */}
